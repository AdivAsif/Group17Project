...
public class AuthResponsesOperationFilter : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        if (authAttributes != null && authAttributes.Any() && !operation.Responses.TryGetValue("401", out _))
            operation.Responses.Add("401", new OpenApiResponse {Description = "Unauthorized"});

        if (authAttributes != null && authAttributes.Any() && !operation.Responses.TryGetValue("403", out _))
            operation.Responses.Add("403", new OpenApiResponse {Description = "Forbidden"});

        if (authAttributes != null && authAttributes.Any() && anonAttributes != null && !anonAttributes.Any())
